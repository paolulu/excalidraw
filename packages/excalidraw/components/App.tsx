...
class App extends React.Component<AppProps, AppState> {
  ...
  lastPointerDownPosition: { x: number; y: number } | null = null;
  lastPointerDownButton: number | null = null;
  hasPanned = false;
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={this.handleCanvasMenuButtonClick}
                          style={{
                            position: "fixed",
                            bottom: "70px",
                            right: "20px",
  ...
  private handleCanvasPointerDown = (
    ...
    this.lastPointerDownButton = event.button;
  ...
  private handleCanvasContextMenu = (
    ...
    // If right-click was used on empty canvas, don't show context menu
    // (right-click on empty areas is now dedicated to canvas panning)
    // But still allow context menu when right-clicking on elements
    if (this.lastPointerDownButton === POINTER_BUTTON.SECONDARY && !element) {
      return;
    }
  ...
  private handleCanvasMenuButtonClick = (
    ...
    const top = event.currentTarget.offsetTop - 10; // slightly above button

    this.setState({
      contextMenu: { top, left, items: this.getContextMenuItems("canvas") },
    });
  };
